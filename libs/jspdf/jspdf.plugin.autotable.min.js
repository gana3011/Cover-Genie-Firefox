      ...
      var t = {
            ...
            Object.defineProperty(e, "__esModule", { value: !0 }),
              (e.default = function (t, e, n, o, i) {
                ...
                ("middle" !== o.valign &&
                  ...
                  "right" !== o.halign) ||
                  (h =
                    (u = "string" == typeof t ? t.split(/\r\n|\r|\n/g) : t)
                      .length || 1);
                (n += l * (2 - 1.15)),
                  "middle" === o.valign
                    ? (n -= (h / 2) * s)
                    : "bottom" === o.valign && (n -= h * s);
                if ("center" === o.halign || "right" === o.halign) {
                  var d = l;
                  if (("center" === o.halign && (d *= 0.5), u && h >= 1)) {
                    for (var c = 0; c < u.length; c++)
                      i.text(u[c], e - i.getStringUnitWidth(u[c]) * d, n),
                        (n += s);
                    return i;
                  }
              ...
              (e.calculateWidths = function (t, e) {
                  ...
                  e.allRows().forEach(function (l) {
                    for (var a = 0, s = e.columns; a < s.length; a++) {
                      ...
                      if (h) {
                        ...
                        h.contentWidth =
                          (0, o.getStringWidth)(h.text, h.styles, t) + c;
                        ...
                        if (
                          ((h.minReadableWidth = f + h.padding("horizontal")),
                          "number" == typeof h.styles.cellWidth)
                        )
                          ...
                          (h.minWidth = h.styles.minCellWidth || g),
                            (h.wrappedWidth = h.contentWidth),
                            h.minWidth > h.wrappedWidth &&
                              (h.wrappedWidth = h.minWidth);
                        }
                      }
                    }
                  }),
                    e.allRows().forEach(function (t) {
                      for (var n = 0, o = e.columns; n < o.length; n++) {
                        var i = o[n],
                          r = t.cells[i.index];
                        if (r && 1 === r.colSpan)
                          (i.wrappedWidth = Math.max(
                            i.wrappedWidth,
                            r.wrappedWidth
                          )),
                            (i.minWidth = Math.max(i.minWidth, r.minWidth)),
                            (i.minReadableWidth = Math.max(
                              i.minReadableWidth,
                              r.minReadableWidth
                            ));
                        else {
                          var l =
                              e.styles.columnStyles[i.dataKey] ||
                              e.styles.columnStyles[i.index] ||
                              {},
                            a = l.cellWidth || l.minCellWidth;
                          a &&
                            "number" == typeof a &&
                            ((i.minWidth = a), (i.wrappedWidth = a));
                        }
                        r &&
                          (r.colSpan > 1 &&
                            !i.minWidth &&
                ...
                (function (t) {
                  for (var e = t.allRows(), n = 0; n < e.length; n++)
                    for (
                      var o = e[n], i = null, r = 0, l = 0, a = 0;
                      a < t.columns.length;
                      a++
                    ) {
                      var s = t.columns[a];
                      if ((l -= 1) > 1 && t.columns[a + 1])
                        (r += s.width), delete o.cells[s.index];
                      else if (i) {
                        var u = i;
                  ...
                  (function (t, e) {
                    for (
                      var n = { count: 0, height: 0 }, o = 0, i = t.allRows();
                      o < i.length;
                      o++
                    ) {
                      for (
                        var l = i[o], a = 0, s = t.columns;
                        a < s.length;
                        a++
                      ) {
                        var u = s[a],
                        ...
                        if (h) {
                          ...
                          if ("linebreak" === h.styles.overflow)
                            h.text = e.splitTextToSize(
                              h.text,
                              d + 1 / e.scaleFactor(),
                              { fontSize: h.styles.fontSize }
                            );
                          else if ("ellipsize" === h.styles.overflow)
                            h.text = r(h.text, d, h.styles, e, "...");
                          else if ("hidden" === h.styles.overflow)
                            h.text = r(h.text, d, h.styles, e, "");
                  ...
                  (function (t) {
                    for (
                      var e = {}, n = 1, o = t.allRows(), i = 0;
                      i < o.length;
                      i++
                    )
                      for (
                        var r = o[i], l = 0, a = t.columns;
                        l < a.length;
                        l++
                      ) {
                        var s = a[l],
            ...
            function r(t, e, n, i, r) {
              return t.map(function (t) {
                return (function (t, e, n, i, r) {
                  ...
                  if (
                    ((e = Math.ceil(e * l) / l),
                    e >= (0, o.getStringWidth)(t, n, i))
                  )
                    return t;
                  for (
                    ;
                    e < (0, o.getStringWidth)(t + r, n, i) && !(t.length <= 1);
                ...
                var c = (function (t, e, n) {
                  ...
                  g = (function (t, e) {
                    ...
                    var b = null !== (l = e.useCss) && void 0 !== l && l,
                      ...
                      S =
                        null !== (a = e.horizontalPageBreakRepeat) &&
                        void 0 !== a
                          ? a
                          : null;
                    return {
                      ...
                      rowPageBreak:
                        null !== (h = e.rowPageBreak) && void 0 !== h
                          ? h
                          : "auto",
                      tableWidth:
                        null !== (d = e.tableWidth) && void 0 !== d
                          ? d
                          : "auto",
                      showHead: y,
                      showFoot: p,
                      ...
                      tableLineColor:
                        null !== (f = e.tableLineColor) && void 0 !== f
                          ? f
                          : 200,
                  ...
                  p = (function (t, e, n) {
                    ...
                    if (e.html) {
                      ...
                      if (n) {
                        var s =
                          (0, r.parseHtml)(t, e.html, n, a, e.useCss) || {};
          ...
          376: function (t, e, n) {
            Object.defineProperty(e, "__esModule", { value: !0 }),
              (e.createTable = function (t, e) {
                var n = new i.DocHandler(t),
                  ...
                  l = new r.Table(e, o);
                return (
                  (0, a.calculateWidths)(n, l), n.applyStyles(n.userStyles), l
                );
              });
            var o = n(28),
              i = n(643),
            ...
            function h(t, e, n, i, r, a, s) {
              ...
              var d = (0, l.assign)({}, h.table, h[t], r.styles, u),
                ...
                g =
                  "body" === t && n % 2 == 0
                    ? (0, l.assign)({}, h.alternateRow, r.alternateRowStyles)
                    : {},
            ...
            Object.defineProperty(e, "__esModule", { value: !0 }),
              (e.parseCss = function (t, e, n, r, l) {
                ...
                var c = "borderTopColor",
                  ...
                  g = r.borderTopWidth;
                if (
                  r.borderBottomWidth === g &&
                  r.borderRightWidth === g &&
                  r.borderLeftWidth === g
                ) {
                ...
                -1 !==
                  (v = ["middle", "bottom", "top"]).indexOf(r.verticalAlign) &&
                  (a.valign = r.verticalAlign);
              ...
              return (
                (t.prototype.getMaxCustomCellWidth = function (t) {
                  for (var e = 0, n = 0, o = t.allRows(); n < o.length; n++) {
                    ...
                    i &&
                      "number" == typeof i.styles.cellWidth &&
                      (e = Math.max(e, i.styles.cellWidth));
                  }
                  return e;
                }),
                t
          ...
          626: function (t, e, n) {
            ...
            function i(t, e, n) {
              ...
              for (
                var h = !0,
                  d =
                    null !== (i = null == n ? void 0 : n.start) && void 0 !== i
                      ? i
                      : 0;
                d < e.columns.length;
              ...
              (e.applyPlugin = function (t) {
                (t.API.autoTable = function () {
                  ...
                  (t.API.autoTableHtmlToJson = function (t, e) {
                    var n;
                    if (
                      (void 0 === e && (e = !1), "undefined" == typeof window)
                    )
                      return (
                        console.error(
                  ...
                  (t.prototype.applyStyles = function (e, n) {
                    ...
                    if (
                      ...
                      h && (o = this.jsPDFDocument).setFillColor.apply(o, h),
                        (h = t.unifyColor(e.textColor)) &&
                          (i = this.jsPDFDocument).setTextColor.apply(i, h),
                        (h = t.unifyColor(e.lineColor)) &&
                          (r = this.jsPDFDocument).setDrawColor.apply(r, h),
          ...
          660: function (t, e, n) {
            ...
            function r(t, e, n, r, a, s) {
              for (
                var u = new o.HtmlRowInput(r), h = 0;
                h < r.cells.length;
                h++
              ) {
                var d = r.cells[h],
          ...
          789: function (t, e, n) {
            ...
            function y(t, e, n, o) {
              ...
              return (
                ("everyPage" === r || ("lastPage" === r && n)) &&
                  (i += e.getFootHeight(e.columns)),
          ...
          try {
            if ("undefined" != typeof window && window) {
              var d = window,
                c =
                  d.jsPDF ||
                  (null === (t = d.jspdf) || void 0 === t ? void 0 : t.jsPDF);
              c && (0, i.applyPlugin)(c);
            }
          } catch (t) {
